...
export const APIKEY_PROVIDERS = {
  ...
  "factory-droid": { id: "factory-droid", alias: "fd", name: "Factory Droid", icon: "smart_toy", color: "#0EA5E9", textIcon: "FD", website: "https://factory.ai", notice: { text: "Factory Droid subscription. Multi-format gateway: Claude Opus 4.7/4.6/4.6-fast/4.5, Claude Sonnet 4.6, MiniMax M2.7, GPT-5.5/5.4 (+ Fast/Mini), Kimi K2.5, GLM 5.1, Gemini 3.1 Pro, Gemini 3 Flash.", apiKeyUrl: "https://app.factory.ai/settings/api-keys" }, serviceKinds: ["llm"] },
