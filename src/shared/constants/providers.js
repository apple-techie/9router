...
export const APIKEY_PROVIDERS = {
  ...
  "factory-droid": { id: "factory-droid", alias: "fd", name: "Factory Droid", icon: "smart_toy", color: "#0EA5E9", textIcon: "FD", website: "https://factory.ai", notice: { text: "Factory Droid subscription. Anthropic-format gateway exposing Claude Opus 4.7/4.6, Sonnet 4.6, Sonnet 4.5, Opus 4.5, Haiku 4.5.", apiKeyUrl: "https://app.factory.ai/settings/api-keys" }, serviceKinds: ["llm"] },
